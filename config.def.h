...
static const char *const autostart[] = {
  "picom", NULL,
  "sh","-c", "/usr/local/src/dwm/autostart.sh", NULL,
  // "dwmblocks", NULL,
	NULL /* terminate */
};
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_F12, spawn, {.v = upvol   } },
	{ MODKEY,				                XK_F6,		spawn,	{.v = light_up} },
	{ MODKEY,				                XK_F5,	spawn,	{.v = light_down} },
};
